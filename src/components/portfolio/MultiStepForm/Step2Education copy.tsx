...
export function Step2Education() {
    ...
    const {
        ...
        defaultValues: {
            education: formData.education || [{ degree: '', institution: '', passingYear: '' }],
            ...
            <Card className="p-6">
                <div className="flex justify-between items-center mb-4">
                    ...
                    <Button
                        ...
                        variant="outline"
                        size="sm"
                        onClick={() => appendEducation({ degree: '', institution: '', passingYear: '' })}
                    >
            ...
            <Card className="p-6">
                <div className="flex justify-between items-center mb-4">
                    ...
                    <Button
                        ...
                        variant="outline"
                        size="sm"
                        onClick={() => appendCertification({ name: '', issuingOrganization: '', year: '' })}
                    >
                        <Plus className="w-4 h-4 mr-2" />
                        Add Certification
                    </Button>
