...
export default function CVReviewModal({
  ...
  if (!result.parsedCV) return null;
  ...
  return (
    <Modal
      ...
      subtitle="Verify the information before filling the form"
      size="5xl"
      footer={
    ...
    >
      {/* Validation Summary */}
      {validation && (
        <div className="mb-6 p-6 border border-gray-200 bg-gray-50 rounded-xl">
